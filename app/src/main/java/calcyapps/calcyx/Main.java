...
import calcyapps.calcyx.R.id;
import calcyapps.calcyx.R.menu;
import calcyapps.calcyx.R.style;
...
public class Main extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		editText = (EditText) findViewById(id.editText1);

		slidingdrawer = (SlidingDrawer) findViewById(id.slidingDrawer1);

		linearlayout1 = (LinearLayout) findViewById(id.linearLayout1);
		...
		buttonMultiply = (Button) findViewById(id.buttonMultiply);
		buttonDivide = (Button) findViewById(id.buttonDivide);
		buttonPoint = (Button) findViewById(id.buttonPoint);

		buttonEqual = (Button) findViewById(id.buttonEqual);

		button_sin = (Button) findViewById(id.button_sin);
		button_cos = (Button) findViewById(id.button_cos);
		button_tan = (Button) findViewById(id.button_tan);
		button_root = (Button) findViewById(id.button_root);
		/*
		...
		EditText result = (EditText) findViewById(id.editText1);
